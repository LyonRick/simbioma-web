...
export function IndicadoresView() {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl">{indicator?.name}</h1>
        ...
        <Tabs value={viewMode} onValueChange={(v) => setViewMode(v as any)}>
          ...
          <TabsContent value="local" className="space-y-6 mt-6">
            ...
            <div className="grid grid-cols-4 gap-4">
              <Card className="h-36">
                <CardContent className="pt-6">
                  <p className="label-uppercase text-muted-foreground mb-2">
                    Actual (2024)
                  </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
              ...
              <div className="lg:col-span-3">
                <ChartContainer
                  title="Tendencia Histórica 2015-2024"
                  exportable={true}
                >
          ...
          <TabsContent value="national" className="space-y-6 mt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card>
                ...
                <CardContent>
                  ...
                  <Badge className="mt-3 bg-emerald-600 text-white">Top 2.3%</Badge>
                </CardContent>
              </Card>
            ...
            {/* Ranking Nacional */}
            <ChartContainer title="Ranking Nacional - Top 10 + Tu Posición" exportable={true}>
            ...
            <ChartContainer title="Evolución vs Promedio Nacional" exportable={true}>
              <ResponsiveContainer width="100%" height={320}>
                <LineChart
                  data={[
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl mb-2">Indicadores Territoriales</h1>
        <p className="text-muted-foreground">
      ...
      <div className="flex gap-4 overflow-x-auto pb-4 -mx-6 px-6 scrollbar-thin">
        {categories.map((category) => (
          <button
            ...
            className={`flex-shrink-0 h-24 w-24 rounded-xl border-2 transition-all hover:scale-105 ${
