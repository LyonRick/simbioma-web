        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-[1.1] mb-6 tracking-tight">
              Inteligencia Territorial para <span className="text-[#2D9D78] font-bold">Regenerar Chile</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <Link href="/#cta-final">
                <Button variant="default" size="lg" className="h-14 px-8 text-lg shadow-verde-bosque/25 bg-[#2D9D78] hover:bg-[#258566] text-white cursor-pointer">
